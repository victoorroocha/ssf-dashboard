...
class ComercialRepository
{
    ...
    public function getClassificacaoClientesSoftsul()
    {
        ...
        return "SELECT E.* 
                ...
                GROUP BY A.ID_PEDIDO,A.CODIGO_PEDIDO,A.DATA_PEDIDO,A.CODIGOSAFRA,A.ID_CLIENTE,A.NOME_CLIENTE,A.CIDADE_CLIENTE,A.ESTADO_CLIENTE,A.CLIENTE_REGIAO,A.CGCCPF_CLIENTE
                ORDER BY A.CGCCPF_CLIENTE, A.DATA_PEDIDO
                ) B
                GROUP BY b.NOME_CLIENTE,b.CGCCPF_CLIENTE,b.ID_CLIENTE,B.CIDADE_CLIENTE,B.ESTADO_CLIENTE,B.CLIENTE_REGIAO
