    ...
    public function getClassificacaoClientesSoftsul()
    {
        ...
        return "SELECT E.* 
                ...
                SELECT 
                    ...
                    ,max(NOME_GRUPO_CLIENTE) as NOME_GRUPO_CLIENTE
                ...
                SELECT 
                    ...
                    ,nvl(MAX(E069GRE.NOMGRE), A.NOME_CLIENTE) AS NOME_GRUPO_CLIENTE
                ...
                LEFT JOIN SAPIENS.E085CLI CLISENIOR ON CLISENIOR.CODCLI = A.ID_CLIENTE
