...
use Application\Repository\VendasRepository;
...
class VendasController extends BaseController
{
    ...
    public function __construct(Adapter $pgAdapter, OracleService $oracleService = null, VendasRepository $VendasRepository = null, Acl $acl)
    {
    ...
    public function listClassificacaoClientesSoftsulAction()
    {
        ...
        try {
            ...
            $result = [];
            $sqlBaseClientes = $this->VendasRepository ? $this->VendasRepository->getClassificacaoClientesSoftsul() : '';
    ...
    public function listPedidosClienteAction()
    {
        ...
        try {
            ...
            // Consulta no Softsul todos pedidos
            $result = [];
            $sqlPedidosCliente = $this->VendasRepository ? $this->VendasRepository->getPedidosCliente($clienteCgcCpf) : '';
